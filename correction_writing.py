...
MODELO_ONNX = "./voiceTts/en_US-ryan-high.onnx" # Cambiá por la ruta real a tu archivo .onnx
...
def main():
    ...
    nombre_base = "./corrections_writing/corregir.odt"
    archivo_salida_odt = f"./corrections_writing/corregido_new.odt"
    archivo_salida_wav = f"./audio/correction_audio.wav"

    print("📖 Leyendo archivo .odt...")
    texto_original = leer_odt(nombre_base)
